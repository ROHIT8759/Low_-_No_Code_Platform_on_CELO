...
export default function DocsPage() {
  return (
    <div className="min-h-screen bg-[var(--surface-0)] text-[var(--text-secondary)]">
      {}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--surface-0)]/80 backdrop-blur-md border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-8 h-8 bg-[var(--surface-2)] rounded flex items-center justify-center text-xs font-bold text-white group-hover:bg-[var(--surface-3)] transition-colors">
                B
              </div>
            ...
            <Link
              href="/builder"
              className="px-4 py-2 bg-primary text-white text-sm font-medium rounded hover:bg-primary/90 transition-all"
            >
              Launch App
            </Link>
          </div>
      ...
      {}
      <section className="pt-40 pb-20 px-6 relative overflow-hidden bg-[var(--surface-0)]">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded border border-white/[0.08] bg-[var(--surface-1)]/70 mb-8">
      ...
      {}
      <section id="how-to-use" className="px-6 py-20 bg-[var(--surface-0)] border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <ScrollReveal delay={100}>
              <div className="p-6 rounded-xl border border-white/[0.08] bg-[var(--surface-1)] hover:border-white/[0.16] hover:bg-[var(--surface-2)] transition-all group">
                <div className="flex justify-between items-start mb-6">
                  <div className="w-10 h-10 rounded bg-[var(--surface-2)] flex items-center justify-center border border-white/[0.08] text-zinc-400 group-hover:text-white transition-colors">
      ...
      {}
      <footer className="border-t border-white/[0.06] bg-[var(--surface-0)] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 transition-all">
            <div className="w-5 h-5 bg-[var(--surface-2)] rounded flex items-center justify-center text-[10px] font-bold">B</div>
