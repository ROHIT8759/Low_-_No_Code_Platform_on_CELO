...
const CATEGORY_COLORS: Record<string, { border: string; bg: string; text: string; accent: string }> = {
    ...
    governance: { border: "border-amber-400/30", bg: "bg-amber-400/5", text: "text-amber-400", accent: "bg-amber-400" },
...
function PropertiesPanel({ block, onClose, onUpdate, onRemove }: PropertiesPanelProps) {
    ...
    return (
        <motion.div
            ...
            className="absolute right-0 top-0 bottom-0 w-72 bg-[var(--surface-1)] border-l border-white/[0.08] z-30 flex flex-col overflow-hidden"
        >
                            ...
                            <div key={prop.key}>
                                ...
                                {prop.type === "toggle" ? (
                                    ...
                                    <input
                                        ...
                                        className="w-full px-2.5 py-1.5 bg-[var(--surface-1)] border border-white/[0.08] rounded text-[11px] text-zinc-200 font-mono focus:outline-none focus:border-primary/50"
                                    />
                                ) : (
                                    <input
                                        type="text"
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                            {DEPENDENCIES[block.type].map(dep => (
                                <span key={dep} className="text-[9px] font-mono text-zinc-500 bg-[var(--surface-2)] px-1.5 py-0.5 rounded border border-white/[0.04]">
                                    {dep.toUpperCase()}
                                </span>
                            ))}
                        </div>
...
export function Canvas() {
    ...
    const prevBlocksCountRef = useRef(0)

    useEffect(() => {
        if (prevBlocksCountRef.current === 0 && blocks.length > 0) {
            setPan({ x: 0, y: 0 })
            setZoom(1)
        }
    ...
    return (
        <div suppressHydrationWarning className="flex-1 relative overflow-hidden flex flex-col">
            <WorkstationHeader
            ...
            <div className="flex-1 relative overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 z-20 flex items-center gap-1 bg-[#090C10] border border-white/[0.06] rounded-md p-1">
                    <button onClick={handleZoomOut} className="p-1.5 hover:bg-[var(--surface-2)] rounded text-zinc-500 hover:text-zinc-300 transition-colors">
                        <ZoomOut className="w-3.5 h-3.5" />
                    </button>
                    <span className="text-[10px] font-mono text-zinc-500 px-2 min-w-[40px] text-center">
                        {Math.round(zoom * 100)}%
                    </span>
                    <button onClick={handleZoomIn} className="p-1.5 hover:bg-[var(--surface-2)] rounded text-zinc-500 hover:text-zinc-300 transition-colors">
                        <ZoomIn className="w-3.5 h-3.5" />
                    </button>
                    <div className="w-px h-4 bg-white/[0.06] mx-0.5" />
                    <button onClick={handleZoomReset} className="p-1.5 hover:bg-[var(--surface-2)] rounded text-zinc-500 hover:text-zinc-300 transition-colors">
                ...
                <div
                    ref={canvasRef}
                    className={`w-full h-full ${isPanning ? "cursor-grabbing" : "cursor-grab"} overflow-hidden`}
                ...
                >
                    ...
                    >
                        {blocks.length === 0 ? (
                                ...
                                <div className="max-w-2xl w-full px-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <button
                                            ...
                                            className="group p-5 bg-[var(--surface-1)] border border-white/[0.08] rounded-md hover:border-blue-500/40 hover:bg-[var(--surface-2)] transition-all text-left"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="group p-5 bg-[var(--surface-1)] border border-white/[0.08] rounded-md hover:border-amber-400/40 hover:bg-[var(--surface-2)] transition-all text-left"
                                        >
                                        ...
                                        <button
                                            className="group p-5 bg-[var(--surface-1)] border border-white/[0.08] border-dashed rounded-md hover:border-zinc-500 hover:bg-[var(--surface-2)] transition-all text-left opacity-50 cursor-not-allowed"
                                        >
                                            <div className="w-8 h-8 rounded bg-[var(--surface-2)] flex items-center justify-center border border-white/[0.06] mb-4">
                            ...
                            <div className="w-full flex flex-col items-center justify-start pt-20 pb-20">
                                {/* Entry point */}
                                    ...
                                    <motion.div
                                        ...
                                        className={`w-72 p-4 rounded-md border cursor-pointer transition-all relative group ${
                                            selectedBlock?.id === baseBlock.id
                                                ...
                                                : "bg-[var(--surface-1)] border-white/[0.08] hover:border-blue-500/30"
                                        }`}
                                    >
                                        {/* Accent strip */}
                                        ...
                                        {/* Input port */}
                                        <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[var(--surface-0)] border-2 border-blue-500/50" />
                                        ...
                                        {/* Output port */}
                                        <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[var(--surface-0)] border-2 border-blue-500/50" />
                                    </motion.div>
                                )}
                                ...
                                {featureBlocks.length > 0 && (
                                    <div className="flex flex-wrap justify-center gap-6 max-w-5xl mt-8 px-4">
                                                ...
                                                <motion.div
                                                    ...
                                                    className={`w-52 p-3 rounded-md border cursor-pointer transition-all relative group ${
                                                        isSelected
                                                            ...
                                                            : "bg-[var(--surface-1)] border-white/[0.08] hover:border-white/[0.12]"
                                                    }`}
                                                >
                                                    {/* Accent strip */}
                                                    ...
                                                    {/* Input port */}
                                                    <div className={`absolute -top-1.5 left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-[var(--surface-0)] border-2 ${colors.border}`} />
