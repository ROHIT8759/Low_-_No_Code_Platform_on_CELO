...
CREATE INDEX IF NOT EXISTS idx_deployed_contracts_contract_address ON deployed_contracts(contract_address);
CREATE INDEX IF NOT EXISTS idx_deployed_contracts_deployed_at ON deployed_contracts(deployed_at DESC);
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view their own projects' AND tablename = 'projects') THEN
        CREATE POLICY "Users can view their own projects" ON projects FOR SELECT USING (true);
    END IF;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view their own deployed contracts' AND tablename = 'deployed_contracts') THEN
        CREATE POLICY "Users can view their own deployed contracts" ON deployed_contracts FOR SELECT USING (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can insert their own deployed contracts' AND tablename = 'deployed_contracts') THEN
        CREATE POLICY "Users can insert their own deployed contracts" ON deployed_contracts FOR INSERT WITH CHECK (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can update their own deployed contracts' AND tablename = 'deployed_contracts') THEN
        CREATE POLICY "Users can update their own deployed contracts" ON deployed_contracts FOR UPDATE USING (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can delete their own deployed contracts' AND tablename = 'deployed_contracts') THEN
        CREATE POLICY "Users can delete their own deployed contracts" ON deployed_contracts FOR DELETE USING (true);
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can view contracts' AND tablename = 'contracts') THEN
        CREATE POLICY "Anyone can view contracts" ON contracts FOR SELECT USING (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can insert contracts' AND tablename = 'contracts') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can view analytics' AND tablename = 'analytics') THEN
        CREATE POLICY "Anyone can view analytics" ON analytics FOR SELECT USING (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can insert analytics' AND tablename = 'analytics') THEN
        CREATE POLICY "Anyone can insert analytics" ON analytics FOR INSERT WITH CHECK (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can update analytics' AND tablename = 'analytics') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can view compilation jobs' AND tablename = 'compilation_jobs') THEN
        CREATE POLICY "Anyone can view compilation jobs" ON compilation_jobs FOR SELECT USING (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can insert compilation jobs' AND tablename = 'compilation_jobs') THEN
        CREATE POLICY "Anyone can insert compilation jobs" ON compilation_jobs FOR INSERT WITH CHECK (true);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can update compilation jobs' AND tablename = 'compilation_jobs') THEN
        CREATE POLICY "Anyone can update compilation jobs" ON compilation_jobs FOR UPDATE USING (true);
    END IF;
END $$;
